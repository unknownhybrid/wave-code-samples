...
namespace PongProject
{
    public class MainScene : Scene
    {
        ...
        protected override void CreateScene()
        {
            ...
            Entity rightPaddle = this.CreateSquareSprite("Right Paddle", RIGHT_PADDLE_STARTING_X, PADDLE_STARTING_Y, PADDLE_FILENAME, true).AddComponent(new ComputerPaddleBehavior(ball.FindComponentOfType<RigidBody2D>()));//new RightPaddleBehavior()); //
